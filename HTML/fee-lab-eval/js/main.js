window.onload = function () {
    ...
    if(aa=="index()"){
        ...
        early();
    } else if(aa=="president()"){ 
        president();
    } else if(aa=="death()"){ 
        death();
    }
    aa="";localStorage.setItem('aa',aa);
...
function hide(){
    let aa=document.getElementsByClassName('active')[0].getAttribute('onclick');
    localStorage.setItem('aa',aa);
    window.location.reload();
}
window.onresize = function () {
    if ((window.innerWidth >= 820 && window.innerWidth <= 850)|| (document.body.clientWidth >= 820 && document.body.clientWidth <= 850)||(document.getElementById('nav-button').style.display == "none" )) {
        hide();
    }
}
...
function show() {
    let x = document.getElementById('pop-nav');
...
window.onscroll = function () {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
        ...
        document.getElementById('image').style.transition = "all 0.5s";
        document.getElementById('caption').style.transition = "all 0.5s";
        if (window.innerWidth <= 830) {
            document.getElementById('cation').style.fontsize = "1rem";
        }
        else {
            document.getElementById('caption').style.fontSize = "1.5rem";
        }
    }
    else {
        document.getElementById('image').style.height = "auto";
        ...
        document.getElementById('image').style.transition = "all 0.5s";
        document.getElementById('caption').style.fontSize = "1rem";
        document.getElementById('caption').style.transition = "all 0.5s";
    }
    if (document.body.scrollTop > 250 || document.documentElement.scrollTop > 250) {
        document.getElementsByTagName('p')[0].style.fontSize = "1.5rem";
        document.getElementsByTagName('p')[0].style.transition = "all 0.2s";
    } else {
        document.getElementsByTagName('p')[0].style.fontSize = "1rem";
        document.getElementsByTagName('p')[0].style.transition = "all 0.5s";
    }
}

function mouse() {
    document.getElementsByTagName('details')[0].onmouseenter = function () {
        document.getElementsByTagName('details')[0].open = true;
    }
    document.getElementsByTagName('details')[0].onmouseleave = function () {
...
function search() {
    ...
    if (search != "" && x != -1) {
        ...
        t.innerHTML = `<button type="button" id="c1" onclick='cancel()'>X</button><h1>Not Found Error</h1><br>
