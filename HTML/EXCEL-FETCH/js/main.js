...
// let r=document.getElementsByTagName('tr')[0].cells.length;
// const arr = [];
// for(let j=0;j<r;j++){
//     arr[j]=document.getElementsByTagName('tr')[0].cells[j].innerHTML;
// }
...
//     for(let j=1;j<i+1;j++){
//         if(rows[j].cells[1].innerText.includes(search) || rows[j].cells[2].innerText.includes(search) || rows[j].cells[3].innerText.includes(search)){
