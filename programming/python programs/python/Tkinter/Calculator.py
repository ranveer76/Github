...
def resize_image(event):
    ...
    resized_image = original_image.resize((w, h), Image.LANCZOS)
...
background_label = tk.Label(app, image=resized_photo)
...
x = tk.Entry(w, textvariable=x2, justify="right", bg="white", fg="black",
...
buttons_frame = tk.Frame(w, bg="black")
